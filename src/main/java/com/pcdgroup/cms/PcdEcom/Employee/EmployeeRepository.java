...
public interface EmployeeRepository extends CrudRepository<Employeemaster, Integer> {
	...
	@Query(nativeQuery = true, value = "SELECT employeeid, employeefname, employeelname, employeedesignation, employeeworkingbrand, employeeworkingtype, employeeemail, employeepassword, employeecontactno, employeeaddress FROM employeemaster WHERE employeeemail = ?1")
	Employeemaster checkDuplicateEmail(String email);
	
	@Query(nativeQuery = true, value = "SELECT employeeid, employeefname, employeelname, employeedesignation, employeeworkingbrand, employeeworkingtype, employeeemail, employeepassword, employeecontactno, employeeaddress FROM employeemaster WHERE employeeemail = ?1 and employeeid <> ?2")
